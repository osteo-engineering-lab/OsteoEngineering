<?php $thisPage="Courtney Kuesel"; $sub=1; ?>
<!DOCTYPE html>
<html lang="en"><head>
...
<div class="container marketing no-carousel"> 
	<div class="row">
		...
		<div class="col-xs-12 col-md-4 pull-left" style="font-size:80%; text-align:center">
			<img src="../img/team/kueselc.jpg" alt="Courtney Kuesel" style="max-width: 300px; height: auto; padding-bottom:0.5em"/>
			<br>Email: Courtney.Kuesel@osumc.edu
		</div><!-- /.span -->
		...
		<div class="col-xs-12 col-md-8">
			...
			<li><p>Sheikh, Abdul Q., Courtney Kuesel, Toloo Taghian, Jennifer R. Hurley, Wei Huang, Yigang Wang, Robert B. Hinton, and Daria A. Narmoneva. "Angiogenic microenvironment augments impaired endothelial responses under diabetic conditions." American Journal of Physiology-Cell Physiology 306, no. 8 (2014): C768-C778.</p></li>
