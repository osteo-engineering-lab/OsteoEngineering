	...
	<div class="row featurette">
        ...
        <div class="col-xs-12 col-md-8">
        	...
        	<div class="row featurette">
        		...
        		<div class="col-xs-12">
          <h1>Postdoctoral Researcher<br> or Graduate Research Assistant. <br><span class="text-muted">BONE TISSUE ENGINEERING.</span></h1>
	 ...
	 <div class="col-md-12">
		<h3>July 2014 Recruitment Presentation</h3>
		<div class="video-container">
